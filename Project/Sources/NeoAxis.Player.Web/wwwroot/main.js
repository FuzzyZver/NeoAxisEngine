...
const splash = (() => {
	...
	img.draggable = false;
	img.style.cssText = "max-width:40vw;max-height:40vh;object-fit:contain;user-select:none;";
	el.appendChild(img);
...
setModuleImports("main.js", {
	initialize: () => {
		...
		const applyCanvasSize = (width, height) => {
			...
			interop.OnCanvasResize(width, height/*, devicePixelRatio*/, fullscreenEnabled);
		}
